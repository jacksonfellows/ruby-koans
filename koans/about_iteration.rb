...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Setting the first item (in the above examples sum or product)
    # to the passed value, it loops through
    # the array running the expression for each item
  end
  ...
  # Because if the file could not be found, the code
  # that depends on it should be contained
  # so that the problem can be handled gracefully
